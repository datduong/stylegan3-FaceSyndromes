...
nvidia_pretrain=/data/duongdb/stylegan3-FaceSyndromes/NvidiaPretrainedModel/stylegan2-ffhq-256x256.pkl # stylegan2-ffhq-256x256.pkl stylegan2-ffhqu-256x256.pkl
...
--cfg=stylegan2 --gpus=2 --batch=32 --gamma=0.4096 --map-depth=8 --glr=0.0025 --dlr=0.0025 --cbase=16384 --snap=10 \
--mirror=1 --kimg=10000 \
--aug=ada \
--cond=True \
--label_combo_dict='{"label1":[0,4],"label2":[4,9]}'
...
# --gamma=1 --map-depth=8 --cbase=16384 --snap=10 
...
IMG_FOLDER = 'TfStyleGAN3LabelRes256Up10' # 'TfStyleGAN3LabelRes256'

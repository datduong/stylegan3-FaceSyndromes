...
--cfg=stylegan2 --gpus=2 --batch=32 --gamma=10 --map-depth=8 --cbase=16384 --snap=10 \
--mirror=1 --kimg=10000 \
--aug=ada \
--cond=True \
--label_embed_dim=512 \
...
IMG_FOLDER = 'TfStyleGAN3LabelRes256Up10+Gender' # 'TfStyleGAN3LabelRes256'
...
os.system('sbatch --partition=gpu --time=72:00:00 --gres=gpu:p100:2 --mem=16g --cpus-per-task=12 '+fname)
